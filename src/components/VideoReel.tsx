...
// import React, { useRef, useEffect, useState } from 'react';
// import { useInView } from 'react-intersection-observer';
// import { Heart, Share2, Volume2, VolumeX, ShoppingBag, Play } from 'lucide-react';
// import { cn } from "@/lib/utils";
// import { useIsMobile } from '@/hooks/use-mobile';
...
//   // Update video muted state when global muted state changes
//   useEffect(() => {
//     if (videoRef.current) {
...
//         console.log("Playback failed:", error);
//         setIsPlaying(false);
//         // If autoplay fails with unmuted video, try muted
//         if (!globalMuted) {
//           videoRef.current.muted = true;
//           setGlobalMuted(true);
//           try {
